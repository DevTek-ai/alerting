...
import com.alerting.domain.Comment;
import com.alerting.repository.CommentRepository;
...
/**
 * REST controller for managing {@link com.alerting.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommentResource {
    ...
    private static final String ENTITY_NAME = "alertingComment";
